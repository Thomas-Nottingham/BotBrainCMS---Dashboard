...
_MAX_LATITUDE = 0x80010000 + 90 * 3600000
_MIN_LATITUDE = 0x80010000 - 90 * 3600000
_MAX_LONGITUDE = 0x80010000 + 180 * 3600000
_MIN_LONGITUDE = 0x80010000 - 180 * 3600000
...
class LOC(dns.rdata.Rdata):
    ...
    def _to_wire(self, file, compress=None, origin=None, canonicalize=False):
        ...
        latitude = 0x80010000 + milliseconds
        milliseconds = (
        ...
        longitude = 0x80010000 + milliseconds
    ...
    def from_wire_parser(cls, rdclass, rdtype, parser, origin=None):
        ...
        if latitude > 0x80010000:
            latitude = (latitude - 0x80010000) / 3600000
        else:
            latitude = -1 * (0x80010000 - latitude) / 3600000
        if longitude < _MIN_LONGITUDE or longitude > _MAX_LONGITUDE:
            raise dns.exception.FormError("bad longitude")
        if longitude > 0x80010000:
            longitude = (longitude - 0x80010000) / 3600000
        else:
            longitude = -1 * (0x80010000 - longitude) / 3600000
